...
**RemoteVRAMMonitor** is a macOS menu bar application that monitors GPU memory
usage on remote servers via SSH. It's built with Swift and SwiftUI.
...
- Modify the `Timer` interval in `VRAMMonitor.swift` line 38 (currently 5.0
  seconds)
